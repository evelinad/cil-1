...
$$ X\_{dn}=(1-\epsilon\_{dn})(U\otimes Z)\_{dn}+\epsilon\_{dn}R\_{dn} $$

The likelihood of a model is then:

$$L(Z,\beta,\epsilon,r;X)=p(X|Z,\beta,\epsilon,r)=\prod\_{n,d}(r^{X\_{dn}}(1-r)^{1-X\_{dn}})^{\epsilon\_{dn}}((1-\prod\_k\beta\_{d\_k}^{Z\_{kn}})^{X\_{dn}}(\prod\_k\beta\_{d\_k}^{Z\_{kn}})^{1-X\_{dn}})^{1-\epsilon\_{d\_n}} $$
